...
Importing this module gives any consumer access to:
  ...
  * The gate-level structure and soundness
    (`QStab.Verifier.QCliffordBundle`).
  * All packaged bundles:
      - `bb72_NZ_joint_bundle` (BB[[72,12,6]] NZ joint X+Z)
      - `bb72_SE_X_bundle` (BB72 SE scheduling, X-side)
      - `surface_d3_X_bundle` (surface d=3 X-side, parametric scheduling)
      - `surface_d3_joint_bundle` (surface d=3 joint, parametric)
      - `hgp_X_bundle` (HGP family, parametric over `HGPSpec d`)
